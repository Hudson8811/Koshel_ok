...
//http://s-yadav.github.io/radialIndicator/
...
;(function (global, factory) {
    ...
    hooks.defineLocale('uk', {
        months : {
            ...
            'standalone': 'січень_лютий_березень_квіте��ь_травень_червень_липень_серпень_вересень_жовтень_листопад_грудень'.split('_')
        },
